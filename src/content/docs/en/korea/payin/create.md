...
| email               | String  | conditionally required | 50 | User email in a valid format. Required when paymentType is 803 (KAKAOPAY). |
...
| phone               | String  | conditionally required | 11 | User mobile number, exactly 11 digits and starting with 010. Required when paymentType is 804 (TOSSPAY). |
