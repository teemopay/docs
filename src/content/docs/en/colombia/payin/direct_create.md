...
| idType          | String | No       | 32     | Id Type: CC (6-10 digits; ID Card), CE (6-10 digits), NIT (9 digits; Tax Identification Number), PA (9 digits; Passport), USER_REF(alphanumeric only). <br/> Mandatory when the paymentType is 201 (PSE) or 202 (WALLET). |
