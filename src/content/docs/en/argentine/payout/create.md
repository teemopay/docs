...
| idType           | String  | yes      | 50     | ID Type: DNI (Personal ID Card - 8 digits), CUIL (Social Security Number - 11 digits), CUIT (Tax ID Number - 11 digits), PASSPORT (Passport - alphanumeric) |
