...
| amount          | String | Yes      | 20     | Amount (integer only). The amount must be a multiple of 10; otherwise, the system blocks the submission. Examples: 10, 110, 120, 130. Invalid examples: 11, 111, 121, 131. |
