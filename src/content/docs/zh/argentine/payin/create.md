...
| amount          | String  | yes | 20   | 代收金额 【比索:ARS】   <br/> <br/> <span style="color: red;">  若商户开启了减免金额，amount必须是是100的倍数,否则系统会进行拦截 </span>             |
...
| expirationTime  | Long    | no  |      | 过期时间 【最小一天,最长七天 毫秒级时间戳 eg:1735660800000】   <br/> <br/> <span style="color: red;">  若商户开启了减免金额，过期时间将置为15分钟 </span> |
